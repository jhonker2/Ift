...
<body>
                            ...
                            <ul class="navbar-nav align-items-center flex-grow-1">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                                        ...
                                        <div class="menu-title d-flex align-items-center">Sondeo Promedio:</div>
                                        <div class="ms-auto dropy-icon"><i class='bx bx-chevron-down'></i></div>
                                    </a>
    ...
    fetch('/api/rutastotalesPromedio2')
        .then(response => {
            if (!response.ok) {
...
function cargarDatosRuta(numeroRuta) {
    Swal.fire({
        title: 'Ingrese Observación para la Ruta',
        input: 'text',
        ...
        if (result.isConfirmed) {
            ...
            // Asegúrate de que la ruta y la observación están correctamente codificadas en la URL
            const url = encodeURI(`/rutasxcuentaPromedio/${numeroRuta}/${observacion}`);
