                    ...
                    <table class="table mb-0 align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <h6 class="mb-0 font-14">Wilson Xavier Garcia</h6>
                                            <p class="mb-0 font-13 text-secondary">Analista informatico de Desarrollo</p>
                                        </div>
                                    </div>
                                </td>
                                <td>0</td>
                                ...
                                <td>14 Oct 2023</td>
                                <td>
                                    <div class="badge rounded-pill bg-primary w-100">En proceso</div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>16 Oct 2023</td>
                                <td>
                                    <div class="badge rounded-pill bg-success w-100">Completado</div>
                                </td>
                            </tr>
                            <tr>
                                <td>
