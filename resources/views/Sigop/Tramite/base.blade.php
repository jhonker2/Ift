...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul>
                        @if (session('SESSION_ROL') == 'ROL_PL_SIGOP' ||
                                session('SESSION_ROL') == 'ROL_DESA' ||
                                        ...
                                        <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
                                            <div class="col">
                                                <a href="https://mail.portoaguas.gob.ec/">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="{{ asset('img/zimbra.png') }}" width="30"
                                                                alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a href="http://intranet.portoaguas.gob.ec/">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="{{ asset('img/logoc.png') }}" width="30"
                                                                alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a
                                                    ...
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="{{ asset('img/saft.png') }}" width="30"
                                                                alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a href="https://portal.compraspublicas.gob.ec/sercop/">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="{{ asset('img/secorp.png') }}" width="30"
                                                                alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a href="http://intranet.portoaguas.gob.ec/rol">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="{{ asset('img/roles.png') }}" width="30"
                                                                alt="">
                                                        </div>
                                                        <div class="app-name">
       ...
       <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
          ...
          class="bx bx-download fs-5"></i><span>Descargar Docs</span></a>
            ...
            <!-- Modal -->
            <div class="modal fade" id="tareaModal" tabindex="-1" aria-labelledby="tareaModalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-md-12">
                                ...
                                <div class="position-relative input-icon">
                                    <input type="text" class="form-control" id="ip_tipo"
                        ...
                        <div class="modal-body">
                            <div class="col-md-12">
                                ...
                                <div class="position-relative input-icon">
                                    ...
                                    <input type="text" class="form-control" id="ip_etfuente"
                                        placeholder="Fuente">
                                    <span class="position-absolute top-50 translate-middle-y"><i
                                            class="bx bx-world"></i></span>
                                </div>
            ...
            <div class="modal fade" id="modal_tarea_tramite" tabindex="-1" style="display: none;"
                aria-hidden="true">
            ...
            <div class="modal fade" id="modal_devolver" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-md-12">
                                <textarea class="form-control" id="ip_observacion_devolver" placeholder="Observacion..." rows="3"></textarea>
    ...
    <div class="modal fade" id="workflowModal" tabindex="-1" aria-labelledby="workflowModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
