                        ...
                        <div class="user-box dropdown px-3">
                            <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                                ...
                                <img src="{{asset('admin_aapp/images/avatars/man.png')}}" class="user-img"
                                    alt="user avatar">
                                <div class="user-info">
                                    <p class="user-name mb-0">Roque Garcia</p>
                ...
                <nav class="navbar navbar-expand-lg align-items-center">
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav align-items-center flex-grow-1">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="http://192.168.1.15/facturas_datos"><i
                            ...
                            <button id="btnCargarCapa" class="btn btn-primary">Cargar Capa</button>
...
var polygonLayerIds = [];
    ...
    const layerId = `poligono-${idRecorridoStr}`;
   ...
   // console.log('Buscando:', { numeroRutaStr, idRecorridoStr });
    //console.log('Resultado de la búsqueda:', rutaData);
    ...
    // Agregar capa de texto para mostrar id_recorrido y cant
    map.addLayer({
        'id': `label-${layerId}`,
        'type': 'symbol',
        'source': layerId,
        'layout': {
            'text-field': `RUTA: ${idRecorridoStr}\nCant: ${cant}`,
            'text-size': 16,
            'text-anchor': 'center',
            'text-offset': [0, 0]
        },
